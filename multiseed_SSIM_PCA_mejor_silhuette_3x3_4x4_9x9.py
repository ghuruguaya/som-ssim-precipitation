# -*- coding: utf-8 -*-
"""
Created on Fri Jul 25 08:53:04 2025
...
# === Clase SOM con BMU por SSIM e inicialización PCA ===
class MiniSom:
...
if __name__ == "__main__":
    ...
    carpeta_salida = r"C:\Users\Gaby\Desktop\SOM\SSIM\som_ssim_pca_mascara_multisemilla"
    ...
    for semilla in semillas:
        ...
        np.save(os.path.join(carpeta_salida, f"bmus_ssim_pca_{size}x{size}_oct_mar_mascara_seed{semilla}.npy"), bmus)
        ...
        plt.hist(ssim_vals, bins=30, color='darkorchid', edgecolor='black')
