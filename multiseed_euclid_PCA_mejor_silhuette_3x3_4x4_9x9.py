# -*- coding: utf-8 -*-
"""
Created on Fri Jul 25 08:37:10 2025
...
# === Clase SOM con distancia euclidiana e inicialización PCA ===
class MiniSom:
    ...
    def _pca_initialization(self, data):
        ...
        for i in range(self.x):
            for j in range(self.y):
                ...
                pca_coord = pca_min + coord * (pca_max - pca_min)
                self.weights[i, j] = pca.inverse_transform(pca_coord)
...
if __name__ == "__main__":
    ...
    carpeta_salida = r"C:\Users\Gaby\Desktop\SOM\EUCLID\som_euclid_pca_mascara_multisemilla"
    ...
    for semilla in semillas:
        ...
        np.save(os.path.join(carpeta_salida, f"bmus_euclid_pca_{size}x{size}_oct_mar_mascara_seed{semilla}.npy"), bmus)
        ...
        plt.hist(correlaciones, bins=30, color='darkcyan', edgecolor='black')
