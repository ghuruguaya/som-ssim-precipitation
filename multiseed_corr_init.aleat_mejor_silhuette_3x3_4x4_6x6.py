# -*- coding: utf-8 -*-
"""
Created on Thu Jul 24 18:39:09 2025
...
# === Clase SOM con correlación y PESOS ALEATORIOS ===
class MiniSom:
    def __init__(self, x, y, input_len, sigma=1.0, learning_rate=0.5):
        ...
        self.weights = np.random.rand(x, y, input_len) * 2 - 1  # Inicialización aleatoria
...
if __name__ == "__main__":
    ...
    carpeta_salida = r"C:\Users\Gaby\Desktop\SOM\CORR\som_corr_random_mascara_multisemilla"
    ...
    for semilla in semillas:
        ...
        np.save(os.path.join(carpeta_salida, f"bmus_cor_random_{size}x{size}_oct_mar_mascara_seed{semilla}.npy"), bmus)
        ...
        plt.hist(correlaciones, bins=30, color='salmon', edgecolor='black')
